...
const BASE = [
 ...
 {id:'herramienta',tipo:'una',texto:'¿Con qué IA vas a practicar hoy?',ayuda:'Basta una cuenta gratuita en el navegador; no necesitas instalar una app.',opciones:['ChatGPT','Claude','Gemini','Otra IA','Todavía no tengo una cuenta']},
